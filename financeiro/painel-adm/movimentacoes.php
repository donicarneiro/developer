...
<small>
	<ul class="nav nav-tabs my-2" id="myTab" role="tablist">
		...
		<li onclick="pesquisarCaixa('', '', 'Cartão de Débito')" class="nav-item" role="presentation">
			<a class="nav-link" id="debito-tab" data-bs-toggle="tab" data-bs-target="#caixa" type="button" role="tab" aria-controls="profile" aria-selected="false">Cartão de Débito</a>
		</li>
		<li onclick="pesquisarCaixa('', '', 'Cartão de Crédito')" class="nav-item" role="presentation">
			<a class="nav-link" id="credito-tab" data-bs-toggle="tab" data-bs-target="#caixa" type="button" role="tab" aria-controls="profile" aria-selected="false">Cartão de Crédito</a>
		</li>
...
<div class="tab-content" id="myTabContent">
	...
	<div class="tab-pane fade show active" id="caixa" role="tabpanel" aria-labelledby="home-tab">
		...
		<div class="row my-3">
			<div class="col-md-9">
				...
				<small class="mx-4"><small>
					<a title="Lançar Despesa" class="text-dark" href="#" onclick="lancarDespesa()">
						
						<span>Despesa</span>
					</a> / 

					<a title="Lançar Receita" class="text-dark" href="#" onclick="lancarReceita()">
						
						<span>Receita</span>
					</a> / 

					<a title="Transferir Valores" class="text-dark" href="#" onclick="transferencias()">
			...
			<div align="right" class="col-md-2">
				<a href="#" onclick="pesquisarCaixa('', '', $('#nome-busca').val(), 'todas')" title="Mostrar todo o Extrato" style="text-decoration:none">
		...
		<small><small>
			<div class="tabela bg-light" id="listar-caixa">
				...
				<div class="modal-body">
					...
					<div class="tab-content my-2" id="myTabContent">
						<div class="tab-pane fade show active" id="dados" role="tabpanel" aria-labelledby="home-tab">
							...
							<div class="row my-2">
								<div class="col-md-1">
									<input type="text" class="form-control" name="Fornecedor"  id="id-cliente" placeholder="Id do Fornecedor" readonly>
								</div>
					...
					<small><div id="mensagem-desp" align="center"></div></small>
				...
				<div class="modal-body">
					...
					<div class="tab-content my-2" id="myTabContent">
						<div class="tab-pane fade show active" id="dados-rec" role="tabpanel" aria-labelledby="home-tab">
							...
							<div class="row my-2">
								<div class="col-md-1">
									<input type="text" class="form-control" name="cliente-rec"  id="id-cliente-rec" placeholder="Id do Cliente" readonly>
								</div>

								<div class="col-md-3">
									<input type="text" class="form-control" name="nome-cliente"  id="nome-cliente-rec" placeholder="Nome do Cliente" readonly>
								</div>
							</div>

							<small>
								<div class="tabela bg-light" id="listar-clientes-rec">
					...
					<small><div id="mensagem-rec" align="center"></div></small>
		...
		<div class="modal-content">
			...
			<form id="form-fec" method="post">
				<div class="modal-body">
					...
					<small><div id="mensagem-fec" align="center"></div></small>
...
<script>
    ...
    $.ajax({
        url: pag + "/listar-caixa.php",
        method: 'POST',
        data: {dataInicial, dataFinal, status, alterou_data, busca},
        dataType: "html",
...
function pesquisarCaixa(tipo, movimento, busca, todas){
    ...
    $.ajax({
        ...
        url: pag + "/listar-caixa.php",
        method: 'POST',
        data: {tipo, movimento, dataInicial, dataFinal, status, busca, todas},
        dataType: "html",
