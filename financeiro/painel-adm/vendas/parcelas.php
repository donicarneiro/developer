...
if($parcelas > 1){
	...
	for($i=1; $i <= $parcelas; $i++){
		$query = $pdo->prepare("INSERT INTO contas_receber set descricao = :descricao, data_emissao = curDate(), vencimento = :data, frequencia = 'Uma Vez',  valor = :valor, usuario_lanc = '$id_usuario', status = 'Pendente', id_venda = '-1'");
